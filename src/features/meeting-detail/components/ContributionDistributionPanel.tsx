...
export const ContributionDistributionPanel: React.FC<ContributionDistributionPanelProps> = ({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-[20px] md:rounded-[32px] p-4 md:p-8 shadow-sm mb-8 md:mb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 md:gap-4 pb-4 md:pb-6 mb-4 md:mb-6 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <label className="text-lg md:text-xl font-black text-slate-900">
